...
test('Existing User Sign In', async ({ page }) => {
    ...
    //await expect(page.locator('text=This user does not exist')).toBeVisible();
    await expect(await page.locator("//div[@data-testid='signin-email-input-message']")).toContainText("This user does not exist");
